...
public class Topic_12_Radio_Checkbox {
    ...
    @Test
    public void TC_02_default_radio_checkbox_2() {
    ...
    public void TC_04_custom_radio_checkbox(){
        ...
        By quangNameCheckbox = By.cssSelector("div[aria-label='Quảng Nam']");
        Assert.assertEquals(driver.findElement(quangNameCheckbox).getAttribute("aria-checked"),"false");
        driver.findElement(quangNameCheckbox).click();
        Assert.assertEquals(driver.findElement(quangNameCheckbox).getAttribute("aria-checked"),"true");
